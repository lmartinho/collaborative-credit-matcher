    ...
    def getSolutionReassignVariableIterator(self, domains, constraints, vconstraints, solution, reassignment_variable):
        ...
        while True:
            ...
            for item in lst:
                ...
                if assignments and not self.isValidSolution(assignments, domains, vconstraints):
        ...
        for variable in domains:
            ...
            for operator in operators:
                ...
                if adjustment_neighbor_solution:
                    if adjustment_neighbor_solution and not self.isValidSolution(adjustment_neighbor_solution, domains, vconstraints):
                        raise InvalidSolutionError
